...
![Conversión de temperatura](https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Temperature_conversion.svg/640px-Temperature_conversion.svg.png)
...
![Balance radiativo](https://www.researchgate.net/publication/318726819/figure/fig2/AS:514103308607488@1499964475403/Schematic-diagram-of-the-energy-balance-components-showing-net-radiation-Rn-and-soil-heat.png)
...
* Se filtran los valores para un mes específico (por ejemplo, enero).
* Se recortan al área de interés (por ejemplo, la provincia del Carchi).
* Se visualiza con una paleta de colores que destaque los rangos de PET.
* Esta visualización se genera con `geemap` en Google Colab o directamente en el Code Editor de GEE.

![Ejemplo de mapa PET](https://i0.wp.com/aemetblog.es/wp-content/uploads/2018/05/112.png?resize=640%2C519&ssl=1)
